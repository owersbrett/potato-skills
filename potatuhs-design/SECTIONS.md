...
site. Sections marked **(optional)** are offered during intake and cut with a
stated reason if they don't apply; everything else is core.
...
**Ask:** Version label and any cover imagery. Nothing else; this page is
assembled last, from the final section list.
...
pairing/contrast table, gradient strips, rule callouts. Every swatch is
...
## 06 · Photography & Illustration (optional)
...
## 07 · Mascots & Characters (optional)
...
screenshots — with anatomy callouts and a state table.
...
## 13 · Sub-brands & Ecosystem (optional)
